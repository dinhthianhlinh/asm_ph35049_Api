...
//                    startActivity(intent);
        ...
        tvDangNhap.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(DangKyActivity2.this,LoginActivity.class);
                startActivity(intent);
            }
        });
    ...
    void createAccountInFireBase(String email,String pass){
        ...
        firebaseAuth.createUserWithEmailAndPassword(email,pass).addOnCompleteListener(DangKyActivity2.this, new OnCompleteListener<AuthResult>() {
            @Override
            public void onComplete(@NonNull Task<AuthResult> task) {
                if(task.isSuccessful()){
                    //tạo tài khoản thành công
                    Utility.showToast(DangKyActivity2.this, "Đăng Ký Thành Công,Hãy Check Email Của Bạn");;
                    firebaseAuth.getCurrentUser().sendEmailVerification();
                    firebaseAuth.signOut();
                    finish();
                }else {
                    Utility.showToast(DangKyActivity2.this, task.getException().getLocalizedMessage());
                }
            }
        });
    }
